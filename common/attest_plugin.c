    ...
    size_t value_size)
{
    ...
    new_claim->value_size = value_size;
    ...
    size_t* claims_length)
{
    ...
    // find the extension
    OE_TRACE_VERBOSE("oe_cert_find_find_extension() succeeded");
    ...
    if (oid_array_index >= 2) // oid_oe_evidence or oid_new_oe_evidence
    {
        ...
        {
            size_t inittime_claims_size = report_size - evidence_size;
            uint8_t* inittime_claims = report + evidence_size;
            _add_claim(
                claims,
                claims_length,
