...
**     ecall_context includes valid debug_eenter_rbp and debug_eenter_rip
**     (i.e., both of which should be set and point to host memory). Otherwise,
**     the function is a no-op. Currently, the stack stitching is required when
**     vDSO is used on Linux.
**
